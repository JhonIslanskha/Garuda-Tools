...
import binascii
from src.core.menu 
import dll_hijacking
from src.core.GarudaTools import *
...
fileopen = open("src/core/lib/dll_hijacking/repository", "r")
...
fileopen = open("src/core/lib/dll_hijacking/hijacking.dll", "rb")
data = fileopen.read()
